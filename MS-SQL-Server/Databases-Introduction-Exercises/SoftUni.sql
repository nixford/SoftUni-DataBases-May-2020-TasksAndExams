...
CREATE TABLE Employees(
	...
	AddressId INT CONSTRAINT FK_Employees FOREIGN KEY REFERENCES Addresses(Id) NOT NULL
) 
...
('Georgi', 'Teziev', 'Ivanov', 'CEO', 2, CONVERT(datetime, '01/02/2013', 103), 3000.00),
('Peter', 'Pan', 'Pan', 'Intern', 3, CONVERT(datetime, '09/12/2007', 103), 599.88)
