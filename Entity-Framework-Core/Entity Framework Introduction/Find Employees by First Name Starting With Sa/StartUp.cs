...
namespace SoftUni
{
    public class StartUp
    {
        ...
        public static string GetDepartmentsWithMoreThan5Employees(SoftUniContext context)
        {
            ...
            {
                sb
                    .AppendLine($"{d.DepartmentName} - " +
                    $"{d.FirstNameManager} " +
                    $"{d.LastNameManager}");

                foreach (var e in d.EmployeesList)
                {
                    sb
                    .AppendLine($"{e.EmployeeFirstName} " +
                    $"{e.EmployeeLastName} - " +
                    $"{e.EmployeeJobTitle}");
                }
            }
        ...
        public static string IncreaseSalaries(SoftUniContext context)
        {
            ...
            IQueryable<Employee> employeesToEncrease = context
                .Employees
            ...
            foreach (Employee employee in employeesToEncrease)
            {
            ...
            var employeesInfo = employeesToEncrease                
                .Select(e => new 
                { 
                    e.FirstName,
                    e.LastName,
        ...
        {
            if (context.Employees.Any(x => x.FirstName == "Svetlin"))
            {
                return "";
            }
